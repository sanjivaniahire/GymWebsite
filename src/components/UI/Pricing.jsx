...
function Pricing() {
  return (
    ...
    <p> We provide you with our best plans curated only for your fitness and health
    each plan has profesionally created features and appropiate values added. 
     You can also customise your Plans according to your convinience!  </p>
    </div>
